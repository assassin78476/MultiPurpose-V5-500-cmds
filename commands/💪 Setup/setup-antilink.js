        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antilink.enabled`) ? "1431196867844374569" : "1431196812349542440"}`
          },
          {
            value: "Settings",
