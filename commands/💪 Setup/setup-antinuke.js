...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    if(message.author.id != message.guild.ownerId){
      if(message.author.id != "1222599088126689292")
      ...
      async function first_layer(){
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<:yes:1431196867844374569> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:yes:1431196867844374569> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Bot add__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:yes:1431196867844374569> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Kick/Ban__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:yes:1431196867844374569> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Create Role__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:yes:1431196867844374569> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Delete Role__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:yes:1431196867844374569> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Create__ Whitelist (module)!**`.substr(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:yes:1431196867844374569> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Delete__ Whitelist (module)!**`.substr(0, 2048))
                    ...
                    async function first_layer(){
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                          if(used33) return menu?.reply({content: `<:no:1431196812349542440> You already selected something, this Selection is now  disabled!`  ,ephemeral: true}) 
            ...
            return menu?.reply({content: "<:yes:1431196867844374569> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
