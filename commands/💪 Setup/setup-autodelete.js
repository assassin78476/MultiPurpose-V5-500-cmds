              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    if(!time || isNaN(time))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:no:1431196812349542440> Invalid Input | Time wrong`)
                    ...
                    if(time > 60*60 || time < 3)
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:no:1431196812349542440> Time out of Range!`)
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<:yes:1431196867844374569> I will now delete Messages after \`${time} Seconds\` in **${channel.name}**`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<:yes:1431196867844374569> Successfully removed **${channel.name}** out of the Setup!`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
