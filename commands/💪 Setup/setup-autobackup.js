...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:no:1431196812349542440> **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:no:1431196812349542440> **You need to be the Owner of this Server!**`)
      }
      ...
      async function first_layer(){
        let menuoptions = [
          ...
          {
            value: "Cancel",
            description: `Cancel and stop the Auto-backup-Setup!`,
