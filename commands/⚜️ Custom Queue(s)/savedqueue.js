  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(` <:yes:1431196867844374569> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substr(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(` <:yes:1431196867844374569> Removed ${counter} Tracks from the Queue \`${Name}\``.substr(0, 256))
