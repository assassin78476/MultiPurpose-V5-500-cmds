...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let guild = client.guilds.cache.get("1416357299093504103")
      return message.reply({content : `**<:no:1431196812349542440> THIS COMMAND IS DISABLED, go to discord.gg/cJkkCtMV99 and <#840332764603351101> to get it restarted!**\n\n\n> **Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
> **Server:**
