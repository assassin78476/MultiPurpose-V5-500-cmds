...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
                        return message.reply("<a:Loading:1433023454587654245> Connecting...")
      let Truchorkodc = client.guilds.cache.get("1416357299093504103")
      ...
      .setColor(es.color)
      .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/a7r25Cz2UD")
